...
import { HiOutlineCog6Tooth, HiOutlineHomeModern, HiOutlineUserCircle, HiOutlineUsers } from "react-icons/hi2";
...
const StyledNavLink = styled(NavLink)`
  ...
  //alt kısım işe yarar react-router aktif olan linke otomatik o active diye işaretler
  ...
  return (
    <nav>
      <NavList>
        ...
        <li>
          <StyledNavLink to="/bookings"><HiOutlineCalendar /><span>Bookings</span></StyledNavLink>
        </li>
        <li>
          <StyledNavLink to="/cabins"><HiOutlineHomeModern /> <span>Cabins</span></StyledNavLink>
        </li>
        <li>
          <StyledNavLink to="/guests"><HiOutlineUserCircle /><span>Guests</span></StyledNavLink>
        </li>
        <li>
